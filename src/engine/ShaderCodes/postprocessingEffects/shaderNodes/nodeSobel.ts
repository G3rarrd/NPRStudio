...
import ShaderSobel from "../nonCompositeTextures/shaderSobel";
...
export class NodeSobel implements ShaderNode {
    public readonly  filter : ShaderSobel;
    ...
    constructor (
        ...
        this.pool = pool;
        this.wgl = wgl;
        this.filter = new ShaderSobel(this.wgl);
        ...
        this.outputSockets = [
            new OutputSocket("Gradient Map", SocketType.IMAGE, this.id)
        ];
