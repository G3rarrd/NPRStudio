...
import ShaderEmboss from "../nonCompositeTextures/shaderEmboss";
...
export class NodeEmboss implements ShaderNode {
    public readonly  filter : ShaderEmboss;
    ...
    constructor (id : number, pool : FramebufferPool,wgl : WebGLCore) {
        ...
        this.pool = pool;
        this.wgl = wgl;
        this.filter = new ShaderEmboss(this.wgl);
