...
import ShaderQuantization from "../nonCompositeTextures/shaderQuantization";
...
export class NodeQuantization implements ShaderNode {
    public readonly  filter : ShaderQuantization;
    ...
    constructor (
        ...
        this.pool = pool;
        // this.wgl = wgl;
        this.filter = new ShaderQuantization(wgl);
...
export default NodeQuantization;