...
import ShaderKuwahara from "../nonCompositeTextures/shaderKuwahara";
...
const SLIDER_CONFIGS = [{label : "radius", min: 4, max: 30, step: 2, value: 6 }];

export class NodeKuwahara implements ShaderNode {
    public readonly  filter : ShaderKuwahara;
    ...
    constructor (
        ...
        this.pool = pool;
        // this.wgl = wgl;
        this.filter = new ShaderKuwahara(wgl);
    ...
    public updateUniformValues () : void {
        ...
        this.filter.setUniformValues(radius);
    }
