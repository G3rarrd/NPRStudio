...
import ShaderSharpen from "../nonCompositeTextures/shaderSharpen";
...
export class NodeSharpen implements ShaderNode {
    public readonly  filter : ShaderSharpen;
    ...
    constructor (
        ...
        this.pool = pool;
        this.wgl = wgl;
        this.filter = new ShaderSharpen(this.wgl);
