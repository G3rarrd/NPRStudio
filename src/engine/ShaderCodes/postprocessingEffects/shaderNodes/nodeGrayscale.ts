...
export class NodeGrayscale implements ShaderNode {
    public readonly  filter : ShaderGrayScale;
    ...
    constructor (
        ...
        this.pool = pool;
        this.wgl = wgl;
        this.filter = new ShaderGrayScale(this.wgl);
