...
import ShaderGeneralizedKuwahara from "../nonCompositeTextures/shaderGeneralizedKuwahara";
...
const SLIDER_CONFIGS = [
            {max : 30, min : 4, label : "radius", value : 5, step : 2},
            {max : 100, min : 1, label : "hardness", value : 50, step : 1},
            {max : 18, min : 1, label : "sharpness", value : 15, step : 1},
            {max : 3, min : 1, label : "zeta", value :2, step : 0.1},
            {max : 360, min :180, label : "angle", value : 240, step : 0.1}
        ]

export class NodeGeneralizedKuwahara implements ShaderNode {
    public readonly  filter : ShaderGeneralizedKuwahara;
    ...
    constructor (
        ...
        this.filter = new ShaderGeneralizedKuwahara(wgl);
    ...
    public updateUniformValues () : void {
        ...
        this.filter.setUniformValues(radius, hardness, sharpness, zeta, angle);
    }
    ...
    public render (
        ...
        this.shaderPass.writeShader({
            program : this.filter.program, inputTextures, textureWidth, 
            textureHeight, fboWrite, 
...
export default NodeGeneralizedKuwahara;